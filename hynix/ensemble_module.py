...
test = pd.read_csv("C:/Users/dykim/OneDrive/바탕 화면/공부자료/22, 23 AI 공부/2023 T아카데미 ASAC/기업 프로젝트/4. web_django/hynix_fab_project/hynix/ensemble/dataset/testset.csv")
