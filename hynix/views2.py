...
from hynix.models import Prediction
...
def get_predictions(test_data):
    ...
    prediction_obj = Prediction.objects.filter(csv_file__contains='prepro_kdy.csv').first()
    ...
    prediction_obj = Prediction.objects.filter(csv_file__contains='prepro_cgw.csv').first()
    ...
    prediction_obj = Prediction.objects.filter(csv_file__contains='prepro_ljw.csv').first()
